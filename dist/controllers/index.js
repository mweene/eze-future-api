...
function getAllFilteredClients(req, res) {
    try {
        ...
        if (!filterString) {
            ...
            const filterClients = db.prepare("SELECT * FROM plots WHERE site_name = ?");
...
export { defaultRoute, getAllClients, getAllFilteredClients, getOneClient, createClient, updateClient, deleteClient, nonExistentRoutes, };
