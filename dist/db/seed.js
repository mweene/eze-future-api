...
function generateAmountPaid(totalCost) {
...
try {
    ...
    const witnessCount = db.prepare("SELECT COUNT(*) as count FROM witness").get();
    const documentsCount = db.prepare("SELECT COUNT(*) as count FROM documents").get();
